    ...
    const ConfirmDialog = () => {
        ...
        return (
            <div className="z-50 confirm-dialog-overlay flex justify-center fixed w-full top-20 left-1 right-1 px-4 pl-2">
                <div className=" min-w-64 confirm-dialog border-l-4 border-purple-600 max-w-[36rem] p-3 pb-2 bg-purple-200 rounded-r-xl rounded-l-none shadow-lg shadow-purple-300">
